...
class comi_conf_comision_html extends html_controler {

    public function select_comi_conf_comision_id(int $cols, bool $con_registros, int|null $id_selected, PDO $link,
                                                ...
                                                bool $required = false): array|string
    {
        ...
        $modelo = new comi_conf_comision($link);
