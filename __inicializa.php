...
$comisiones = new gamboamartin\comisiones\instalacion\instalacion();

$instala = $comisiones->instala(link: $link);

if(errores::$error){
    $link->rollBack();
    $error = (new errores())->error(mensaje: 'Error al instalar comisiones', data: $instala);
    print_r($error);
    exit;
}
