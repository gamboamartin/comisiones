...
class controlador_comi_rel_periodo_comision extends _ctl_parent_sin_codigo {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new comi_tipo_comision(link: $link);
        $html_ = new comi_tipo_comision_html(html: $html);
