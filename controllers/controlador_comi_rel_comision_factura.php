...
use gamboamartin\comisiones\html\comi_rel_comision_factura_html;

use PDO;
use stdClass;

class controlador_comi_rel_comision_factura extends _ctl_parent_sin_codigo {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new comi_rel_comision_factura(link: $link);
        $html_ = new comi_rel_comision_factura_html(html: $html);
    ...
    {
        $columns["comi_rel_comision_factura_id"]["titulo"] = "Id";
        $columns["comi_rel_comision_factura_descripcion"]["titulo"] = "Descripción";

        $filtro = array("comi_rel_comision_factura.id","comi_rel_comision_factura.descripcion");
