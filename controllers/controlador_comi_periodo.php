...
use gamboamartin\comisiones\html\comi_periodo_html;
use gamboamartin\comisiones\models\comi_comision;
use gamboamartin\comisiones\models\comi_periodo;
...
class controlador_comi_periodo extends _ctl_parent_sin_codigo {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new comi_periodo(link: $link);
        $html_ = new comi_periodo_html(html: $html);
    ...
    {
        $this->seccion_titulo = 'Periodo';
        $this->titulo_lista = 'Registro de Periodo';
    ...
    {
        $columns["comi_periodo_id"]["titulo"] = "Id";
        $columns["comi_periodo_descripcion"]["titulo"] = "Descripción";

        $filtro = array("comi_periodo.id","comi_periodo.descripcion");
